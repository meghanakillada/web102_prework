...
const moneyRaised = totalRaised.toLocaleString(); // Assuming totalRaised is previously defined
const gamesCount = totalGames;
const unfundedGamesString = (unfundedGamesCount === 1) ? `${unfundedGamesCount} game` : `${unfundedGamesCount} games`;
const descriptionString = `A total of ${moneyRaised} has been raised for ${gamesCount} games. Currently, ${unfundedGamesCount} ${unfundedGamesString} remain unfunded. We need your help to fund these amazing games!`;
